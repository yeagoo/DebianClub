  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { text: t.observability, url: u('/production-observability') },
        { text: t.freshness, url: u('/content-freshness') },
        { text: t.i18nQuality, url: u('/i18n-quality') },
