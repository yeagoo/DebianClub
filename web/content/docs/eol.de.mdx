...
| Codename                 | Veröffentlichungs­datum | Ende des regulären Supports | Ende des Langzeit­supports (LTS) | ELTS-Ende |
| :----------------------- | :---------------------- | :-------------------------- | :-------------------------------- |-----------|
...
| **Debian 11 (Bullseye)** | 2021-08-14              | Juli 2024                   | 2026-08-31                        | 2031-06-30 |
...
<Callout type="warn" title="Debian 12 ist in der LTS-Phase">

Der reguläre Sicherheits­support für Debian 12 (Bookworm) endete am **2026-07-11**. Seitdem übernimmt das LTS-Team die Wartung bis **2028-06-30**. Ein Upgrade auf Debian 13 (Trixie) wird empfohlen.

</Callout>

<Callout type="warn" title="Debian 11 LTS ist beendet">

Der LTS-Support für Debian 11 (Bullseye) endete am **2026-08-31**. Debian bietet keine Sicherheitsupdates mehr; ein Teil der Pakete wird über **ELTS** bis **2031-06-30** unterstützt. Planen Sie Migration, Isolation oder Abschaltung.
