...
This page is based on official Debian release information as of **2026-07-03**. Debian version status changes with point releases, security-support transitions, and LTS announcements. Before upgrading, check [Debian Releases](https://www.debian.org/releases/) and [Debian LTS](https://wiki.debian.org/LTS).
