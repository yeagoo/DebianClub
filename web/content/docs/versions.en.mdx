...
This page is based on official Debian release information as of **2026-09-08**. Debian version status changes with point releases, security-support transitions, and LTS announcements. Before upgrading, check [Debian Releases](https://www.debian.org/releases/) and [Debian LTS](https://wiki.debian.org/LTS).
...
| Still on Debian 11 | **Upgrade to Debian 12, then Debian 13** | Bullseye LTS ended on 2026-08-31; only some packages are covered by third-party ELTS, so it should not be used for new deployments |
...
| Debian 11 (Bullseye) | LTS ended (ELTS) | Legacy systems only | Third-party ELTS (partial packages) | Migrate, isolate, or retire |
...
| Debian 11 (Bullseye) | 2021-08-14 | Ended | 2026-08-31 (ended) | Migrate, use ELTS, or retire |
| Debian 10 (Buster) | 2019-07-06 | Ended | 2024-06-30 | Should not remain internet-facing |

Debian 11 LTS ended on **2026-08-31**. Debian no longer provides security updates; a subset of packages is covered by third-party ELTS until **2031-06-30**.

As of **2026-09-08**, the latest point release is **13.6** (2026-07-11) for Debian 13 and **12.15** (2026-07-11) for Debian 12; Debian 13.7 is planned for 2026-09-12.
...
## Live Version Matrices

The table above shows baseline versions at release time. To see the **current version** of a package in Debian and other major distributions, along with dependencies and CVE status, use the cross-distro lookup from [pkgseek](https://pkgseek.com/) (the matrices below load live from pkgseek):
...
Look up any package at [pkgseek.com](https://pkgseek.com/); package pages follow the format `https://pkgseek.com/packages/<name>`.
...
| Debian 12 | Plan Debian 13 upgrade | Regular security support ended on 2026-07-11; the release is now in LTS, so plan the upgrade |
| Debian 11 | Upgrade to Debian 12, then Debian 13; if that is impossible, evaluate ELTS or retirement | LTS ended on 2026-08-31; avoid jumping across multiple stable releases in one step |
