...
This page is based on official Debian release information as of **2026-07-01**. Debian version status changes with point releases, security-support transitions, and LTS announcements. Before upgrading, check [Debian Releases](https://www.debian.org/releases/) and [Debian LTS](https://wiki.debian.org/LTS).
...
`Estimated` means Debian 13 regular support and LTS transition dates are not final yet. Follow Debian official announcements.
