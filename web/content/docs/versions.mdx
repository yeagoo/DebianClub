...
本页按 **2026-08-01** 的 Debian 官方发布信息整理。Debian 版本状态会随点更新、安全支持切换和 LTS 公告变化；执行升级前，请再次查看 [Debian 发布信息](https://www.debian.org/releases/) 与 [Debian LTS](https://wiki.debian.org/LTS)。
