...
![Ciclo de vida de soporte de Debian](/images/lifecycle.png)
...
| Nombre en clave              | Fecha de lanzamiento | Fin del soporte regular | Fin del soporte a largo plazo (LTS) | Fin de ELTS |
| :--------------------------- | :------------------- | :---------------------- | :---------------------------------- |-----------|
...
| **Debian 11 (Bullseye)**     | 2021-08-14           | julio 2024              | 2026-08-31                          | 2031-06-30 |
...
<Callout type="warn" title="Debian 12 ha entrado en LTS">

El soporte de seguridad regular de Debian 12 (Bookworm) finalizó el **2026-07-11**. Desde entonces se encuentra en la fase de Soporte a Largo Plazo, mantenida por el equipo LTS hasta el **2028-06-30**. Se recomienda planificar la actualización a Debian 13 (Trixie).

</Callout>

<Callout type="warn" title="Debian 11 LTS ha finalizado">

El soporte LTS de Debian 11 (Bullseye) finalizó el **2026-08-31**. Debian ya no ofrece actualizaciones de seguridad; parte de los paquetes está cubierta por **ELTS** hasta el **2031-06-30**. Planifique la migración, el aislamiento o la retirada.
