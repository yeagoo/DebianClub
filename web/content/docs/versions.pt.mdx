...
|---|---|---|---|
| **Status da versão** | Estável atual | Estável anterior | LTS encerrado (ELTS) |
| **Data de lançamento** | agosto 2025 | junho 2023 | agosto 2021 |
| **Último lançamento pontual** | 13.6 (2026-07-11) | 12.15 (2026-07-11) | — |
| **Fim do suporte** | 2030-06-30 | 2028-06-30 | 2026-08-31 (encerrado) |
...
- **🖧 Administrador de servidores**:
  ...
  - **Manutenção de sistemas antigos**: O **Debian 12 (Bookworm)** como oldstable ainda é mantido (até ~2028). O suporte LTS do **Debian 11 (Bullseye)** terminou em 2026-08-31; o Debian não fornece mais atualizações de segurança e parte dos pacotes é coberta pelo ELTS até 2031-06-30. Planeje a migração ou o descomissionamento.
...
- **Do Debian 12**: Recomenda-se atualizar para o **Debian 13**. Com vários lançamentos pontuais (13.6), está bem consolidado.
