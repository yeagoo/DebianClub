...
本页按 **2026-07-01** 的 Debian 官方发布信息整理。Debian 12（Bookworm）的常规安全支持计划持续到 **2026-07-11**，LTS 计划持续到 **2028-06-30**。请以 [Debian Releases](https://www.debian.org/releases/) 与 [Debian LTS](https://wiki.debian.org/LTS) 为最终来源。
...
Debian 13 的 regular support 和 LTS 日期仍属于预估，后续会随 Debian 官方公告更新。
