...
本页按 **2026-08-01** 的 Debian 官方发布信息整理。Debian 12（Bookworm）的常规安全支持已于 **2026-07-11** 结束并转入 LTS，LTS 计划持续到 **2028-06-30**。请以 [Debian Releases](https://www.debian.org/releases/) 与 [Debian LTS](https://wiki.debian.org/LTS) 为最终来源。
