...
This page is based on official Debian release information as of **2026-07-03**. Regular security support for Debian 12 (Bookworm) is scheduled until **2026-07-11**, and LTS is scheduled until **2028-06-30**. Treat [Debian Releases](https://www.debian.org/releases/) and [Debian LTS](https://wiki.debian.org/LTS) as the final sources.
