...
This page is based on official Debian release information as of **2026-09-08**. Regular security support for Debian 12 (Bookworm) ended on **2026-07-11** and it has moved into LTS, which is scheduled until **2028-06-30**. Debian 11 (Bullseye) LTS ended on **2026-08-31**; Debian no longer provides security updates, and a subset of packages is covered by third-party ELTS until **2031-06-30**. Treat [Debian Releases](https://www.debian.org/releases/) and [Debian LTS](https://wiki.debian.org/LTS) as the final sources.
...
| Codename | Release date | Regular security support ends | LTS ends | ELTS ends | Current advice |
|----------|--------------|-------------------------------|----------|-----------|----------------|
| Debian 13 (Trixie) | 2025-08-09 | 2028-08-09 | 2030-06-30 | 2035-06-30 | Preferred for new deployments |
| Debian 12 (Bookworm) | 2023-06-10 | 2026-07-11 | 2028-06-30 | 2033-06-30 | Plan Debian 13 upgrade |
| Debian 11 (Bullseye) | 2021-08-14 | Ended | 2026-08-31 (ended) | 2031-06-30 | Migrate, use ELTS, or retire |
| Debian 10 (Buster) | 2019-07-06 | Ended | 2024-06-30 | 2029-06-30 | Should not remain internet-facing |
| Debian 9 (Stretch) | 2017-06-17 | Ended | 2022-06-30 | 2027-06-30 | Retire or isolate |
| Debian 8 (Jessie) | 2015-04-25 | Ended | 2020-06-30 | 2025-06-30 | Retire or isolate |

Debian 13 regular security support, LTS, and ELTS dates follow the current Debian Releases and Debian LTS/Extended LTS pages and should be updated when Debian publishes changes.
