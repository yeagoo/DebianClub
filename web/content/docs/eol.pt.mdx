...
| Codinome                     | Data de lançamento | Fim do suporte regular | Fim do suporte de longo prazo (LTS) | Fim do ELTS |
| :--------------------------- | :----------------- | :--------------------- | :---------------------------------- |-----------|
...
| **Debian 11 (Bullseye)**     | 2021-08-14         | julho 2024             | 2026-08-31                          | 2031-06-30 |
...
<Callout type="warn" title="O LTS do Debian 11 terminou">

O suporte LTS do Debian 11 (Bullseye) terminou em **2026-08-31**. O Debian não fornece mais atualizações de segurança; parte dos pacotes é coberta pelo **ELTS** até **2031-06-30**. Planeje a migração, o isolamento ou o descomissionamento.
