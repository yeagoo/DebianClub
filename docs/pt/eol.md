...
<Callout type="warn" title="O Debian 12 está se aproximando do LTS">

O suporte de segurança regular do Debian 12 (Bookworm) está previsto até **2026-07-11**. Depois disso, a equipe LTS manterá a versão até **2028-06-30**. Recomenda-se planejar a atualização para o Debian 13 (Trixie).
